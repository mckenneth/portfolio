...
<html lang="en">
  <head>
    ...
    <title>Font Reference - fontastic</title>
  ...
  <body>
    <div class="container">
      ...
      <ul class="glyphs css-mapping">
        <li>
          <div class="icon icon-information-small"></div>
        ...
        <li>
          <div class="icon icon-music-note-2"></div>
        ...
        <li>
          <div class="icon icon-photos-outline"></div>
          <input type="text" readonly="readonly" value="photos-outline">
        </li>
        <li>
          <div class="icon icon-screen-full"></div>
          <input type="text" readonly="readonly" value="screen-full">
        </li>
        <li>
        ...
        <li>
          <div class="icon icon-resize-small"></div>
          <input type="text" readonly="readonly" value="resize-small">
        </li>
        <li>
          <div class="icon icon-resize-full"></div>
